...
let schema = {
  createCompany: Joi.object({
    ...
    address_number: Joi.string().required().messages({
      "string.base": errors.string.empty(),
      "string.empty": errors.string.empty(),
      "any.required": errors.string.empty(),
    }),
    complement: Joi.string().allow("", null).optional().messages({
      "string.base": errors.string.empty(),
    }),
    birthDate: Joi.string().allow("", null).optional().messages({
      "string.base": errors.string.empty(),
    }),
    companyType: Joi.string().allow("", null).optional().messages({
      "string.base": errors.string.empty(),
    }),
    incomeValue: Joi.number().required().messages({
      "number.base": errors.string.empty(),
      "any.required": errors.string.empty(),
    }),
  ...
  editCompany: Joi.object({
    ...
    asaas_status: Joi.string().allow('', null).optional()
  }),
  editRole: Joi.object({
    id: Joi.number().integer().messages({
      "number.base": errors.integer.base(),
