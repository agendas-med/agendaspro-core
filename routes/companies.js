...
router.patch("/", login, validate.validateRequest(validate.schemas.companies.editCompany), (req, res, next) => {
    _companiesService.checkCompanyAdmin(req.usuario.id, req.body.id).then(() => {
        _companiesService.editCompany(req.body.id, req.body.name, req.body.address, req.body.city, req.body.state, req.body.business_type, req.body.zip_code, req.body.configurations).then(() => {
